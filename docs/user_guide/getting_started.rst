...
Its aim is being able to manage a ton of data represented in multiple ways and be able to build a unified output with
a proper annotation file structure. This package was thought not only to work with biological data, also, it can be used
to any kind of data that can be represented as a table.
...
in order to manage data in the best way possible and later on performance a decent analysis. In the following section
...
into the multiple :ref:`Examples` that we built. In case that you want to be engage and contribute to the project,
