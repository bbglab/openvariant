...
class TestGroupBy(unittest.TestCase):
    ...
    def test_group_by(self):
        ...
        res = [g for g, v in list(group_by(f'{os.getcwd()}/tests/data/', f'{os.getcwd()}/tests/data/task_test.yaml', 'DATASET', quite=True))]
        self.assertEqual(res, res_expect)

    def test_invalid_group_by(self):
        res = list(group_by(f'{os.getcwd()}/tests/data/', f'{os.getcwd()}/tests/data/task_test.yaml', 'NO_EXIST', quite=True))
    ...
    def test_group_by_equal_where(self):
        ...
        res_groups = set()
        for g, v in list(group_by(f'{os.getcwd()}/tests/data/', f'{os.getcwd()}/tests/data/task_test.yaml', 'DATASET',
    ...
    def test_group_by_bad_fromat_where(self):
        with self.assertRaises(ValueError):
            list(group_by(f'{os.getcwd()}/tests/data/', f'{os.getcwd()}/tests/data/task_test.yaml', 'DATASET', where="NOT_EXIST = \"not_exist\"",
                          quite=True))
