...
class TestCat(unittest.TestCase):
    ...
    def test_cat_basic(self):
        ...
        cat(f'{os.getcwd()}/tests/data/example1')
    ...
    def test_cat_with_annotation(self):
        captured_output = StringIO()
        sys.stdout = captured_output
        cat(f'{os.getcwd()}/tests/data/example1', f'{os.getcwd()}/tests/data/example1/example1.yaml')
        sys.stdout = sys.__stdout__
    ...
    def test_cat_equal_where(self):
        captured_output = StringIO()
        sys.stdout = captured_output
        cat(f'{os.getcwd()}/tests/data/example1', where="variant == 'DEL'")
        sys.stdout = sys.__stdout__
    ...
    def test_cat_less_than_where(self):
        captured_output = StringIO()
        sys.stdout = captured_output
        cat(f'{os.getcwd()}/tests/data/example1', where="POSITION < 56515295")
        sys.stdout = sys.__stdout__
    ...
    def test_cat_greater_than_where(self):
        captured_output = StringIO()
        sys.stdout = captured_output
        cat(f'{os.getcwd()}/tests/data/example1', where="POSITION > 56515295")
        sys.stdout = sys.__stdout__
        with open(f'{os.getcwd()}/tests/data/task_cat/test_greater_than_where.tsv') as f:
            lines = f.readlines()
        self.assertEqual(''.join(lines), captured_output.getvalue())
    ...
    def test_cat_no_exist_where(self):
        captured_output = StringIO()
        sys.stdout = captured_output
        cat(f'{os.getcwd()}/tests/data/example1', where="NO_EXIST == 'no_exist'")
        sys.stdout = sys.__stdout__
    ...
    def test_cat_no_headers(self):
        captured_output = StringIO()
        sys.stdout = captured_output
        cat(f'{os.getcwd()}/tests/data/example1', header_show=False)
        sys.stdout = sys.__stdout__
