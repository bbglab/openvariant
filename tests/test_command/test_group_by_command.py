...
class TestGroupByCommand(unittest.TestCase):
    ...
    def test_group_by_command(self):
        runner = CliRunner()
        result = runner.invoke(groupby, [f'{getcwd()}/tests/data/example1'])
        self.assertEqual(result.exit_code, 0)
        self.assertNotEqual(result.output, None)

    def test_group_by_command_more_flags(self):
        runner = CliRunner()
        result = runner.invoke(groupby, [f'{getcwd()}/tests/data/example1', '--header', '--show', '--group_by',
    ...
    def test_group_by_command_no_exist_group_by(self):
        runner = CliRunner()
        result = runner.invoke(groupby, [f'{getcwd()}/tests/data/example1', '--group_by', 'NO_EXIST'])
    ...
    def test_group_by_command_invalid_group_by(self):
        runner = CliRunner()
        result = runner.invoke(groupby, [f'{getcwd()}/tests/data/example1', '--group_by'])
    ...
    def test_group_by_command_no_exist_annotation(self):
        runner = CliRunner()
        result = runner.invoke(groupby, [f'{getcwd()}/tests/data/example1', '--group_by',
                                         'DATASET', '--annotations', f'{getcwd()}/tests/data/example1/no_exist.yaml'])
    ...
    def test_group_by_command_invalid_annotation(self):
        runner = CliRunner()
        result = runner.invoke(groupby, [f'{getcwd()}/tests/data/example1', '--group_by', 'DATASET', '--annotations'])

        self.assertEqual(result.exit_code, 2)

    def test_group_by_command_no_exist_cores(self):
        runner = CliRunner()
        result = runner.invoke(groupby, [f'{getcwd()}/tests/data/example1', '--group_by', 'DATASET',
                                         '--cores', 'NO_EXIST'])
    ...
    def test_group_by_command_invalid_cores(self):
        runner = CliRunner()
        result = runner.invoke(groupby, [f'{getcwd()}/tests/data/example1', '--group_by', 'DATASET', '--cores'])
